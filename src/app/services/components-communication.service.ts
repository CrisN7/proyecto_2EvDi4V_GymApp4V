...
export class ComponentsCommunicationService {
  ...
  private selectedDate: Subject<Date> = new Subject<Date>();//Subject es una clase de RxJS que actúa como un emisor de datos (Observable) y, al mismo tiempo, como un receptor de datos (Observer). Aquí, dataSubject se declara como un Subject que emitirá valores de tipo string.
